...
import 'package:agriChikitsa/screens/tab.screens/hometab.screen/weather.screen/weathersScreen.dart';
...
class Routes {
  Map<String, Widget Function(BuildContext)> routes = {
    ...
    RouteName.weatherScreenRoute: (context) => const WeatherScreen(),
