              ...
              child: Column(
                children: [
                  ...
                  Padding(
                    ...
                    child: Row(
                      children: [
                        SubHeadingText(AppLocalizationsHi().verifyDetails)
                      ],
                    ),
                  ),
                  Padding(
            ...
            SizedBox(
              ...
              child: Column(
                children: [
                  Row(
                    children: [
                      ParagraphHeadingText(AppLocalizationsHi().enterOTPs)
                    ],
                  ),
                  OtpTextField(
                    numberOfFields: 6,
                    ...
                    children: [
                      Consumer<SignInViewModel>(
                        ...
                        return !provider.showResendOTPButton
                            ...
                            : ParagraphText(
                                AppLocalizationsHi().dintreceivetheOTP);
                      }),
                    ],
                  ),
                  const SizedBox(
                  ...
                  Consumer<SignInViewModel>(
                    ...
                    return CustomElevatedButton(
                      ...
                      title: AppLocalizationsHi().verifyProcess,
                      width: dimension["width"]! - 32,
