...
class EditProfileScreen extends HookWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final useViewModel =
        useMemoized(() => Provider.of<EditProfileViewModel>(context, listen: false));
                  ...
                  children: [
                      ...
                      builder: (context, provider, child) => Input(
                        ...
                        onFieldSubmitted: (value) {
                          ...
                          Utils.fieldFocusChange(
                              context, useViewModel.nameFocusNode, useViewModel.emailFocusNode);
                        },
                      ),
                    ),
                    const SizedBox(
                    ...
                    Consumer<EditProfileViewModel>(
                      builder: (context, provider, child) => Input(
                        ...
                        validator: (value) => useViewModel.emailFieldValidator(context, value),
                    ...
                    Consumer<EditProfileViewModel>(
                      builder: (context, provider, child) => CustomElevatedButton(
                          title:
                              AppLocalization.of(context).getTranslatedValue("update").toString(),
