...
class ChatHistory extends HookWidget {
  ...
  const ChatHistory({super.key, required this.notificationItem});
  @override
                      ...
                      : Expanded(
                          child: Padding(
                            ...
                            child: ListView.builder(
                                itemCount: useViewModel.chatHistoryList['allChats'].length,
                                itemBuilder: (context, index) {
                                  final chatItem = useViewModel.chatHistoryList['allChats'][index];
