        ...
        child: Column(
          children: [
            ...
            Consumer<NotificationViewModel>(
              ...
              return useViewModel.chatHistoryList.isEmpty
                  ? const SizedBox(
                      child: Center(
                  ...
                  : Expanded(
                      ...
                      child: ListView.builder(
                          itemCount:
                              useViewModel.chatHistoryList['allChats'].length,
                          itemBuilder: (context, index) {
                            final chatItem =
                                useViewModel.chatHistoryList['allChats'][index];
                            return chatItem['adminReply']
                                ? SizedBox(
                                    child: Column(
                                      children: [
