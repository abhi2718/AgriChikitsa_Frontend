        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              child: Text(
                AppLocalization.of(context).getTranslatedValue("ndviPromoDescription").toString(),
              ...
              child: Row(
                ...
                children: [
                  ...
                  TextButton(
                      onPressed: () async {
                        await useViewModel
                            .addFieldForMonitoring(context, selectedPlot.id)
                            .then((value) {
                                        ...
                                        return Container(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              const Text(
                                                "Your field is added for monitoring!",
                                                style: TextStyle(
