...
class PlotDetails extends HookWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      onWillPop: () async {
        if (useViewModel.fieldName.isEmpty || useViewModel.soilType.isEmpty) {
          return true;
        }
        useViewModel.createPlot(context, isBackPressed: true);
        return false;
      },
      child: Scaffold(
              ...
              children: [
                  ...
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      hintText: AppLocalization.of(context)
                          .getTranslatedValue("enterPlotName")
                          .toString(),
                      filled: true,
                ...
                Container(
                  ...
                  child: DropdownButton(
                      ...
                      onChanged: (value) {
                        provider.setSoilType(value.toString());
                      }),
                ),
                InkWell(
                  onTap: () {
